...
<body>
    ...
    <section id="prodetails" class="section-p1">
        <div class="single-pro-img">
           <img src="/img/keyboard.jpg" width="100%" id="mainimg" alt="" class="src"> 

        </div>
        <div class="single-pro-details">
            <h2>Zebronics Gaming Keyboard And Mouse Combo</h2>
            <h6>Special price</h6>
            <h1>&#8377;1,999</h1>
           <h4> Quantity</h4>
            <input type="number" value = "1">
            <button class="buy" onclick="openPopup()">Buy Now</button>
            <button class="cart"onclick="openPopup()">Add To Cart</button>
    ...
    <section>
        ...
        <div class="pro-container">
            <div class="pro">
                <img src="img/camera.jpg"alt=""class="src"onclick="window.location.href='sproduct.php';">
                <div class="des">
                    <span>Zebronics</span>
    ...
    <!-- <div class="popup1" id="popup1">
        ...
        <p>You can veiw your item in cart!!</p>
