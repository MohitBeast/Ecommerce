...
<body>
    ...
    <section id="prodetails" class="section-p1">
        <div class="single-pro-img">
           <img src="/img/i1.jpg" width="100%" id="mainimg" alt="" class="src"> 
    ...
    <section>
        ...
        <div class="pro-container">
            <div class="pro">
                <img src="img/f6.jpeg"alt=""class="src"onclick="window.location.href='pro4.php';">
                <div class="des">
                    <span>Zebronics</span>
        ...
        <div class="pro-container">
            <div class="pro">
                <img src="img/f4.jpeg" alt="" class="src">
                <div class="des">
                    <span>Oppo</span>
                    <h5>Oppo F21 Pro</h5>
                    <div class="star">
        ...
        <div class="pro-container">
            <div class="pro">
                <img src="img/f3.jpeg" alt="" class="src">
                <div class="des">
                    <span>i-phone </span>
        ...
        <div class="pro-container">
            <div class="pro">
                <img src="img/f2.jpeg" alt="" class="src">
                <div class="des">
                    <span>Samsung</span>
                    <h5>Samsung Hd TV</h5>
                    <div class="star">
        ...
        <div class="pro-container">
            <div class="pro">
                <img src="img/f1.jpeg" alt="" class="src">
                <div class="des">
                    <span>Dell</span>
                    <h5>Dell laptop </h5>
                    <div class="star">
